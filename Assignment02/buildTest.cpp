...
int main( int argc, char **argv ) {
	...
	glClear( GL_COLOR_BUFFER_BIT );
        ...
        GLfloat xTrans = cos( (GLfloat)glfwGetTime() ) / 2;
        GLfloat yTrans = sin( (GLfloat)glfwGetTime() ) / 2;
        transform = glm::translate( transform, glm::vec3( xTrans, yTrans, 1.0f ) );
        ...
        // Create Transformations
        transform = glm::mat4();
        transform = glm::translate( transform, glm::vec3( 0.0f, yTrans, 1.0f ) );
